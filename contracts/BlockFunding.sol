...
contract BlockFunding {
    ...
    function setPetition(string memory _name,uint256 _amountNeeded,address _recipient) public{
    ...
    function payRecipient(uint256 index) public payable isExist(index) returns (string memory result)
    {
        Petitions storage _petition = petition[index];
